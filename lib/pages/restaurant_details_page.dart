...
class _RestaurantDetailsPageState extends State<RestaurantDetailsPage> {
  ...
  void _getCurrentUserAndIsLiked() async {
    ...
    DocumentReference docRef = FirebaseFirestore.instance.collection('users').doc(_user.uid);
  ...
  Future<List<RestaurantReviews>> _getReviews() async {
    final Uri uri = Uri.parse("https://developers.zomato.com/api/v2.1/reviews?res_id=${widget.data.restaurantId}&count=0");
    var reqData = await http.get(uri,
